...
import { equals, findLastIndex, findSingle, focus, isEmpty, isNotEmpty, resolveFieldData, uuid } from '@openng/optimus-ui-utils';
import { OverlayOptions, OverlayService, PrimeTemplate, ScrollerOptions, SharedModule, TranslationKeys } from '@openng/optimus-ui/api';
...
import { ChevronDownIcon, SpinnerIcon, TimesCircleIcon, TimesIcon } from '@openng/optimus-ui/icons';
...
} from '@openng/optimus-ui/types/autocomplete';
