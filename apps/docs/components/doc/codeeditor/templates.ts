...
<html lang="en">
    <head>
        ...
        <link rel="icon" type="image/svg+xml" href="https://optimus.openng.org/logo-icon.svg">
    </head>
    <body>
        <${selector}></${selector}>
    </body>
