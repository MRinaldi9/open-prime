...
@Component({
    ...
    imports: [AppDoc],
    template: `
        <app-doc docTitle="Angular Ifta Label Component - Optimus UI" header="IftaLabel" description="IftaLabel is used to create infield top aligned labels." [docs]="docs" themeDocs="iftalabel" [apiDocs]="['IftaLabel']" [ptDocs]="ptComponent"></app-doc>
    `
})
