...
@Component({
    template: ` <app-doc docTitle="Angular Gallery Component - Optimus UI" header="Galleria" description="Galleria is an advanced content gallery component." [docs]="docs" [apiDocs]="['Galleria']" [ptDocs]="ptComponent" componentName="Galleria"></app-doc>`,
    standalone: true,
    imports: [AppDoc],
