...
@Component({
    standalone: true,
    imports: [AppDoc],
    template: ` <app-doc docTitle="Angular Drawer Component - Optimus UI" header="Drawer" description="Drawer is a container component displayed as an overlay." [docs]="docs" [apiDocs]="['Drawer']" [ptDocs]="ptComponent" componentName="drawer"></app-doc> `
})
