...
@Component({
    template: ` <app-doc docTitle="Angular IconField Component - Optimus UI" header="IconField" description="IconField wraps an input and an icon." [docs]="docs" [ptDocs]="ptComponent" [apiDocs]="['IconField', 'InputIcon']" themeDocs="iconfield"></app-doc>`,
    standalone: true,
    imports: [AppDoc]
})
