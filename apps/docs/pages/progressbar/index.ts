...
@Component({
    template: `<app-doc docTitle="Angular ProgressBar Component - Optimus UI" header="ProgressBar" description="ProgressBar is a process status indicator." [docs]="docs" [ptDocs]="ptComponent" [apiDocs]="['ProgressBar']" themeDocs="progressbar"></app-doc>`,
    standalone: true,
    imports: [AppDoc]
})
