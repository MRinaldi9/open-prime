...
@Component({
    template: `<app-doc docTitle="Angular Slider Component - Optimus UI" header="Slider" description="Slider is a component to provide input with a drag handle." [docs]="docs" [apiDocs]="['Slider']" themeDocs="slider" [ptDocs]="ptComponent"></app-doc>`,
    standalone: true,
    imports: [AppDoc]
})
