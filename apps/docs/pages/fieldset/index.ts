...
@Component({
    ...
    imports: [AppDoc],
    template: `
        <app-doc docTitle="Angular Fieldset Component - Optimus UI" header="Fieldset" description="Fieldset is a grouping component with a content toggle feature." [docs]="docs" [apiDocs]="['Fieldset']" themeDocs="fieldset" [ptDocs]="ptComponent"></app-doc>
    `
})
