...
@Component({
    ...
    imports: [AppDoc],
    template: `
        <app-doc docTitle="Angular Float Label Component - Optimus UI" header="FloatLabel" description="FloatLabel appears on top of the input field when focused." [docs]="docs" [ptDocs]="ptComponent" themeDocs="floatlabel" [apiDocs]="['FloatLabel']"></app-doc>
    `
})
