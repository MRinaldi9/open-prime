...
@Component({
    ...
    imports: [AppDoc],
    template: `
        <app-doc docTitle="Angular Carousel Component - Optimus UI" header="Carousel" description="Carousel is a content slider featuring various customization options." [docs]="docs" [apiDocs]="['Carousel']" [ptDocs]="ptComponent" themeDocs="Carousel"></app-doc>
    `
})
