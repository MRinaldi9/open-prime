...
@Component({
    template: `<app-doc docTitle="Angular Menubar Component - Optimus UI" header="Menubar" description="Menubar is a horizontal menu component." [docs]="docs" [apiDocs]="['Menubar', 'MenuItem']" [ptDocs]="ptComponent" themeDocs="menubar"></app-doc> `,
    standalone: true,
    imports: [AppDoc]
})
