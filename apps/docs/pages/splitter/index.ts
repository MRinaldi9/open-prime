...
@Component({
    template: `<app-doc docTitle="Angular Splitter Component - Optimus UI" header="Splitter" description="Splitter is utilized to separate and resize panels." [docs]="docs" [apiDocs]="['Splitter']" [ptDocs]="ptComponent" themeDocs="splitter"></app-doc>`,
    standalone: true,
    imports: [AppDoc]
})
