...
@Component({
    standalone: true,
    imports: [AppDoc],
    template: ` <app-doc docTitle="Angular DatePicker Component - Optimus UI" header="DatePicker" description="DatePicker is an input component to select a date." [docs]="docs" [apiDocs]="['DatePicker']" [ptDocs]="ptComponent" themeDocs="datepicker"></app-doc> `
})
