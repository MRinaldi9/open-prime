...
@Component({
    template: `<app-doc docTitle="Angular Toast Component - Optimus UI" header="Toast" description="Toast is used to display messages in an overlay." [docs]="docs" [apiDocs]="['Toast', 'ToastMessage']" [ptDocs]="ptComponent" themeDocs="toast"></app-doc> `,
    standalone: true,
    imports: [AppDoc]
})
