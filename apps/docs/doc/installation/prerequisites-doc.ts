...
@Component({
    ...
    template: `
        <app-docsectiontext>
            ...
            <p>
                Already using PrimeNG? Do not follow this page. The <a [routerLink]="'/migration/primeng'" class="doc-link">migration guide</a> covers moving an existing PrimeNG v21 workspace across, and the same
                <i>ng add</i> command detects that case for you.
            </p>
        </app-docsectiontext>
    `
})
