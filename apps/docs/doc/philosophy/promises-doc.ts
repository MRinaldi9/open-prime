...
@Component({
    ...
    template: `
        <app-docsectiontext>
            ...
            <p>
                Every package we publish is MIT licensed. There is no paid edition, no enterprise build, no feature held back behind a subscription, and no plan to introduce one. If that ever changed, it would be a fork of this project rather than
                a relicensing of it, because the code we inherited is MIT and so is everything we add to it.
            </p>
            <h3>We track Angular</h3>
            <p>
                Our release cadence follows Angular's. When a new Angular major lands, the priority is a compatible Optimus UI major — before new features, before refactors. Staying upgradeable is the single most valuable thing a component
                library can do for the applications built on it.
            </p>
